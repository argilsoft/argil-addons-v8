...
class sale_order_line(osv.osv):
    ...
    def product_id_change_with_wh(self, cr, uid, ids, pricelist, product, qty=0,
        ...
        ### ARGIL ###
        if warehouse_id:
            context_warehouse = context.copy()
            context_warehouse.update({'warehouse' : warehouse_id})
        product_obj = product_obj.browse(cr, uid, product, context=(warehouse_id and context_warehouse or context))
	### ARGIL ###
